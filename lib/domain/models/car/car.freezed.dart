...
class _$CarImpl implements _Car {
  ...
  @override
  String toString() {
    return 'Car(id: $id, car: $car, model: $model, color: $color, modelYear: $modelYear, vin: $vin, price: $price, availability: $availability)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, id, car, model, color, modelYear, vin, price, availability);
